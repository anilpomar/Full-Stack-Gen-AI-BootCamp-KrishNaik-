...
| Multi-tenant metadata | —_client_id, document_id, contract_group_id          | Need access-safe retrieval                |
...
![Image](C:\Mine\AI\Full Stack Gen AI  BootCamp (KrishNaik)\Practicals\Class-32-18-July-2026_DataParsing_Extended\data\rag_ready_document_artifacts\image_000000_d2826d28bd575ff41463d98693ecf481d874a970f6bdf6da67b22cb919c8c22c.png)
...
| CRM-OPS-005 _— | CityRide Mobility        | CSV         | 48,200 rows | Incident records              | Needs column type normalization            |
...
![Image](C:\Mine\AI\Full Stack Gen AI  BootCamp (KrishNaik)\Practicals\Class-32-18-July-2026_DataParsing_Extended\data\rag_ready_document_artifacts\image_000001_ff3432e70d6a8e6701ecd19cdc14a47f114c1fdd8ee70e2200bd55bd5f1afb41.png)
...
```
# Runbook: Contract Ingestion Failure ## Symptoms -Upload status remains 'processing' for more than 30 minutes. -Worker logs show repeated timeout errors. -Vector count does not increase for the affected document. ## Recovery Steps 1. Confirm the object exists in document storage. Re-run parser with "safe_mode=True'. Rebuild chunks with the previous chunking configuration. Compare chunk count with the last successful ingestion. Trigger re-embedding only for changed chunks. ORwWNd
```
...
![Image](C:\Mine\AI\Full Stack Gen AI  BootCamp (KrishNaik)\Practicals\Class-32-18-July-2026_DataParsing_Extended\data\rag_ready_document_artifacts\image_000002_f3c5244959af5f99713a1d386e712d8cf02a3868848ef6ac03a022e3afcd087a.png)
...
![Image](C:\Mine\AI\Full Stack Gen AI  BootCamp (KrishNaik)\Practicals\Class-32-18-July-2026_DataParsing_Extended\data\rag_ready_document_artifacts\image_000003_fe76c58a2e20fd31f7cf5949e572265c7079d98f75beb7e4ba2ed3c1265cb9b6.png)
...
2nd @ Sp PESPOrSIDIILY Cel Where OWNED And DACKUP are SMUOWN INSIUe Ue Same row.
...
| Data Protection | Notify client about any confirmed data incident within 72 hours.                           | = Owner Backup     | Security pro           | Incident classified as confirmed breach | Incident report, timeline, notification proof | Critical |
...
| Support         | Provide P1 response within 30 minutes during school operating hours.                       | Owner Backup       | Suppart L2 Ops Manager | Ticket priority = P1                    | Ticket timestamps + agent assignment lag      | High     |
...
|                       | Annual Scheol360 Enterprise Subscription 12 campuses   |                     | INR 11,00,000   |               |                      | INR 12,986,000   |
|-----------------------|--------------------------------------------------------|---------------------|-----------------|---------------|----------------------|------------------|
|                       | Parent communication add-on. estimated message pack    | &#124; 200.000 mags | INR 0.38/meq    | a             | a                    | INR 89,680       |
| &#124; Implementation | Data migration + training + go-live support            | &#124; 1            | INR 2,40,000    | [5%           | om                   | INR 2,83,200     |
| &#124; Summary        | Subtotal and taxes                                     | :                   | INR 14,176,000  | [INR 1.27.440 | &#124; INR 1,27,.440 | INR 16,70,880    |
...
![Image](C:\Mine\AI\Full Stack Gen AI  BootCamp (KrishNaik)\Practicals\Class-32-18-July-2026_DataParsing_Extended\data\rag_ready_document_artifacts\image_000004_fdd1d4287bf388fb38c9ede3526db047de66b344f5b315050bd9a41e71a006e8.png)
...
![Image](C:\Mine\AI\Full Stack Gen AI  BootCamp (KrishNaik)\Practicals\Class-32-18-July-2026_DataParsing_Extended\data\rag_ready_document_artifacts\image_000005_759d502b70b6260d7e8e66d053a26fc4206c582f811d247ce72c349cedb202c5.png)

| HM oHigh risk: 12 clauses   |
|-----------------------------|
| {Medium risk: 21 clauses    |
| fl Low risk: 45 clauses     |
...
![Image](C:\Mine\AI\Full Stack Gen AI  BootCamp (KrishNaik)\Practicals\Class-32-18-July-2026_DataParsing_Extended\data\rag_ready_document_artifacts\image_000006_6cb053bf42d48c694a2600040c52c8ee27482a121096d201747b2fd9995e18d4.png)
...
Due within 15 days. Late fee May apply after due date. Footer note: Amount includes taxes unless separately mentioned. OCR challenge: faint stamp, rotated page, table lines, and handwritten

Received by: K. Mehta

![Image](C:\Mine\AI\Full Stack Gen AI  BootCamp (KrishNaik)\Practicals\Class-32-18-July-2026_DataParsing_Extended\data\rag_ready_document_artifacts\image_000007_178831b0ea891a53c7144c1103abdc7b65a7e79c21414a02c8bd64f0a7197428.png)
...
scanned image. Parsing challenge: extract bill number, issuer, line items, usage quantity, tax split, total payable, and payment notes from a
...
![Image](C:\Mine\AI\Full Stack Gen AI  BootCamp (KrishNaik)\Practicals\Class-32-18-July-2026_DataParsing_Extended\data\rag_ready_document_artifacts\image_000008_85ec771b6316bb5d32afc941e765602bf920e98f1a16222968df67751f8bac2a.png)
...
![Image](C:\Mine\AI\Full Stack Gen AI  BootCamp (KrishNaik)\Practicals\Class-32-18-July-2026_DataParsing_Extended\data\rag_ready_document_artifacts\image_000009_46749f64f612c023900e7f467da5e071bdfe6727b77bb773ed36af05064aa0a8.png)
...
| Elemen         | Parsing Challenge                                | Expected Handling                                                       |
|----------------|--------------------------------------------------|-------------------------------------------------------------------------|
...
| Image metadata | File name, page, and bounding box may be needed. | _—_— Store metadata for citation and retrieval.                         |
